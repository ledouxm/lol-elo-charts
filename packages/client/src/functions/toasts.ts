...
import { getRandomString, isDev } from "@pastable/core";
...
export const defaultToast = (options: ToastOptions) => makeToast({ ...toastConfigs.default, ...options });
...
export const warningToast = (options: ToastOptions) => makeToast({ ...toastConfigs.warning, ...options });
